          ...
          <div className="w-full p-4 ">
            <div className="flex flex-col gap-7">
              ...
              <div className="flex flex-col justify-between items-end md:flex-row">
                <h1 className="text-5xl font-semibold max-w-[16ch] w-full text-wrap">
                  We offer a wide range of services
                </h1>
                <p className="text-xl max-w-[60ch] w-full text-gray-700 text-wrap">
                  By combining our industry knowledge with cutting-edge tools
                  and methodologies, we develop strategies that drive measurable
                  results.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-180 pt-20">
            ...
            <div className=" md:row-span-2 relative rounded-3xl overflow-hidden group hover:cursor-pointer">
              ...
              <div className="absolute bottom-4 left-10 right-10 text-white">
                ...
                <p className="max-h-0 opacity-0 overflow-hidden group-hover:max-h-20 group-hover:opacity-100 transition-all duration-300 text-white/80 max-w-[60ch] text-wrap">
                  Our research services provide valuable insights into market
            ...
            <div className="relative rounded-3xl overflow-hidden group hover:cursor-pointer">
              ...
              <div className="absolute bottom-4 left-10 right-10 text-white">
                ...
                <p className="max-h-0 opacity-0 overflow-hidden group-hover:max-h-20 group-hover:opacity-100 transition-all duration-300 text-white/80 max-w-[60ch] text-wrap">
                  Our strategic planning services help businesses define their
                  vision, set objectives, and develop plans to achieve their
                  goals.
                </p>
              </div>
            </div>
            ...
            <div className="relative rounded-3xl overflow-hidden group hover:cursor-pointer">
              ...
              <div className="absolute bottom-4 left-10 right-10 text-white">
                ...
                <p className="max-h-0 opacity-0 overflow-hidden group-hover:max-h-20 group-hover:opacity-100 transition-all duration-300 text-white/80 max-w-[60ch] text-wrap">
                  From planning and budgeting to risk management, our financial
                  advisory services help businesses optimize performance.
                </p>
              </div>
            </div>
          </div>
